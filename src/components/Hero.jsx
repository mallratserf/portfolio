  ...
  return (
    <div id="home" className="px-16 flex min-h-screen w-full items-center justify-center py-28 md:py-28 selection:bg-purple-300 selection:text-yellow-900">
        <div className="flex flex-col items-center justify-center gap-10 text-white">
            ...
            >
              <img src={pfp} alt="" className=" flex mt-12 h-[350px] w-[350px] cursor-pointer rounded-3xl shadow-xl shadow-neutral-400 transition-all duration-200 hover:-translate-y-5 hover:scale-105 hover:shadow-2xl hover:shadow-neutral-300 md:w-[350px] md:h-[350px]"/>
            </motion.div>
